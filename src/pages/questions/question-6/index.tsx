...
const questions: Question = {
  question: 'Гиперрефлективные фокусы (локализация)',
  options: [
    { text: 'Отсутствие', points: 0 },
    { text: 'Внутренние слои сетчатки', points: 1 },
    { text: 'Наружные слои сетчатки', points: 2 },
  ],
};
      ...
      <div className="wrapper">
        <div className="card">
          ...
          <div className="wrapper__links">
            <div>
              <img className={mod.img} src={image.q_6} alt="img" />
            </div>
